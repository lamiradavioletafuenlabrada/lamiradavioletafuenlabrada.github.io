...
function Hero() {
  ...
  return (
    ...
    >
      <div
        ref={imageRef}
        className="absolute -inset-y-24 inset-x-0 bg-cover bg-[position:72%_56%] will-change-transform sm:bg-[position:76%_58%] lg:bg-contain lg:bg-no-repeat lg:bg-[position:82%_68%] xl:bg-[position:78%_72%]"
