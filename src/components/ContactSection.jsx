        ...
        <Reveal className="rounded-[32px] border border-brand-200 bg-brand-100/70 p-8 text-center shadow-card sm:p-12">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-3 rounded-full bg-brand-500 px-6 py-3 text-sm font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-brand-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2"
            >
