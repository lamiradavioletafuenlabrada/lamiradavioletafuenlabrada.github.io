    ...
    <section id="quienes-somos" className="relative isolate scroll-mt-28 overflow-hidden bg-brand-100 py-20 sm:py-24">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-5 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        <div className="space-y-8">
          ...
          <Reveal delay={120} className="space-y-5 text-[1.1rem] leading-7 text-mist sm:text-[1.16rem] sm:leading-8">
            ...
            {pillars.map((pillar, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 text-[1.03rem] leading-6 text-mist sm:text-[1.06rem] sm:leading-7">{pillar.description}</p>
                </Reveal>
              );
            })}
          </div>
